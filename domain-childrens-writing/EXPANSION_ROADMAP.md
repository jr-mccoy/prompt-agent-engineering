...
**Status (2026-09-24):** All 12 items below are **built** (coverage audit pass; see [`meta/COVERAGE_ROADMAP.md`](../meta/COVERAGE_ROADMAP.md)). Filed as: 1 `fiction-workshops/childrens_series_bible_builder.md`; 2 `publishing-business/childrens_self_publishing_prep.md`; 3 `fiction-workshops/childrens_wordless_picture_book_workshop.md`; 4 `fiction-workshops/childrens_branching_narrative_workshop.md`; 5 `craft-tools/childrens_decodable_text_mechanics.md`; 6 `craft-tools/childrens_audiobook_production_considerations.md`; 7 `publishing-business/childrens_book_marketing_copy.md`; 8 `publishing-business/childrens_school_visit_prep.md`; 9 `representation-collaboration/childrens_illustration_brief_for_hire.md`; 10 `nonfiction-workshops/childrens_informational_picture_book_workshop.md`; 11 `publishing-business/childrens_translation_rights_considerations.md`; 12 `publishing-business/childrens_grant_fellowship_application_prep.md`. They use the repo-wide Tier 1 section order (When to Use → Inputs → Method → Output Format → Verification → False-Positive Prevention → Example) rather than the older in-domain order described below.

**Original status:** Brainstorm only — produced from a full-domain review (all 22 then-existing prompts + README re-read against the age-band table and stated conventions).
