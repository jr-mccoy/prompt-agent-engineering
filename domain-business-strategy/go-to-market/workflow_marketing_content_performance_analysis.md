---
title: "Content Performance Analysis & Gap Identification"
category: business-strategy/go-to-market
description: "Analyze content performance data against funnel stages and audience segments to find what is working, what is redundant, and which gaps are worth filling next."
techniques:
  - ST-01
  - ST-02
  - CM-01
...
# Content Performance Analysis & Gap Identification

**Source:** WORKFLOW_DRIVEN_PROMPTS.md

**Category:** Workflow / Marketing
...
- **Purpose:** Optimize content marketing strategy through performance analysis and gap identification
- **Job Family:** Marketing / Content Marketing
- **Workflow Stage:** Monthly/quarterly content strategy reviews
- **Key Features:**
  - Content portfolio health assessment (top/middle/bottom performers)
  - Audience and keyword gap analysis
  - Conversion path mapping to identify missing content bridges
  - Format ROI analysis to guide investment decisions
  - Content refresh strategy for declining high-value pieces
  - 90-day roadmap with specific actions and metrics
  - Competitive content positioning analysis
