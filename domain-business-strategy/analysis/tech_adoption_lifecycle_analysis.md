...
- `domain-business-strategy/analysis/business_impact_analysis.md` — Translate features into prioritized business value.
- `domain-business-strategy/analysis/customer_journey_map_analysis.md` — Map how users move through the product.
- `domain-business-strategy/analysis/stakeholder_persona_generation.md` — Infer the adopter personas the product serves.
