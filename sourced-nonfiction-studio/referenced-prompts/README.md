...
| 6 Assembly | `domain-research-academic/research_secondary_source_synthesis.md` · `domain-education-teaching/learner-writing/learnwrite_citation_helper.md` · `domain-prompt-engineering/rag-prompts/rag_citation_format_designer.md` |
