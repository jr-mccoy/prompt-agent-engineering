---
title: "Orchestration Patterns for Multi-Step AI Workflows"
category: meta
description: "You are a strategic planner. Given this task, create a detailed execution plan."
tags:
  - meta
updated: "2025-12-24"
---
...
**Prerequisites**: Familiarity with foundational patterns, particularly chain-of-thought and structured output.
...
**Cross-reference**: Uses structured output and role assignment patterns.
...
**Cross-reference**: Combines reflection with iterative execution.
...
**Cross-reference**: Planner uses hierarchical breakdown, executor uses domain-specific patterns.
...
**Cross-reference**: Each specialist uses appropriate role assignment and domain patterns.
...
**Cross-reference**: Uses reflection pattern but separates roles for stronger critique.
...
**Cross-reference**: Similar to self-consistency but with explicit comparison logic.
...
**Cross-reference**: Tool selector uses chain-of-thought for planning.
...
**Cross-reference**: Uses structured output for call planning.
...
**Cross-reference**: State manager uses structured output for state representation.
...
**Cross-reference**: Combines multiple patterns from this document with foundational patterns from prompt-patterns.md.
