---
title: "Voice of Customer Synthesis Slide Visual"
category: presentations/board-decks/image-generation
description: "Constraint-locked image prompt for a board-deck VoC synthesis visual in 16:9 format."
techniques:
  - SV-11
  - SV-12
  - SV-13
...
# Voice of Customer Synthesis Slide Visual

## Prompt

```text
Create a SINGLE FLAT PRINT ARTWORK image for an executive board deck: **VoC synthesis**.
...
- ZONE 2 (middle, 64% height): Main analytic visual for VoC synthesis.
...
2) Clear board-slide visual for VoC synthesis, not generic art.
