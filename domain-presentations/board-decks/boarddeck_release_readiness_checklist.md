---
title: "Release Readiness Checklist Slide Visual"
category: presentations/board-decks/image-generation
description: "Constraint-locked image prompt for a board-deck release readiness checklist visual in 16:9 format."
techniques:
  - SV-11
  - SV-12
  - SV-13
...
# Release Readiness Checklist Slide Visual

## Prompt

```text
Create a SINGLE FLAT PRINT ARTWORK image for an executive board deck: **release readiness checklist**.
...
- ZONE 2 (middle, 64% height): Main analytic visual for release readiness checklist.
...
2) Clear board-slide visual for release readiness checklist, not generic art.
