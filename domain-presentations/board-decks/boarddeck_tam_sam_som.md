---
title: "TAM / SAM / SOM Slide Visual"
category: presentations/board-decks/image-generation
description: "Constraint-locked image prompt for a board-deck TAM/SAM/SOM visual in 16:9 format."
techniques:
  - SV-11
  - SV-12
  - SV-13
...
# TAM / SAM / SOM Slide Visual

## Prompt

```text
Create a SINGLE FLAT PRINT ARTWORK image for an executive board deck: **TAM/SAM/SOM**.
...
- ZONE 2 (middle, 64% height): Main analytic visual for TAM/SAM/SOM.
...
2) Clear board-slide visual for TAM/SAM/SOM, not generic art.
