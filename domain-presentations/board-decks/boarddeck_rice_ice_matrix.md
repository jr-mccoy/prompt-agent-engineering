---
title: "RICE / ICE Matrix Slide Visual"
category: presentations/board-decks/image-generation
description: "Constraint-locked image prompt for a board-deck RICE/ICE matrix visual in 16:9 format."
techniques:
  - SV-11
  - SV-12
  - SV-13
...
# RICE / ICE Matrix Slide Visual

## Prompt

```text
Create a SINGLE FLAT PRINT ARTWORK image for an executive board deck: **RICE/ICE matrix**.
...
- ZONE 2 (middle, 64% height): Main analytic visual for RICE/ICE matrix.
...
2) Clear board-slide visual for RICE/ICE matrix, not generic art.
