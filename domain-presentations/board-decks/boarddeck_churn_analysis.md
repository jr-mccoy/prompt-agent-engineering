---
title: "Churn Analysis Slide Visual"
category: presentations/board-decks/image-generation
description: "Constraint-locked image prompt for a board-deck churn analysis visual in 16:9 format."
techniques:
  - SV-11
  - SV-12
  - SV-13
...
# Churn Analysis Slide Visual

## Prompt

```text
Create a SINGLE FLAT PRINT ARTWORK image for an executive board deck: **churn analysis**.
...
- ZONE 2 (middle, 64% height): Main analytic visual for churn analysis.
...
2) Clear board-slide visual for churn analysis, not generic art.
