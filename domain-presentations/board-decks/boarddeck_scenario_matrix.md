---
title: "Scenario Matrix Slide Visual"
category: presentations/board-decks/image-generation
description: "Constraint-locked image prompt for a board-deck scenario matrix visual in 16:9 format."
techniques:
  - SV-11
  - SV-12
  - SV-13
...
# Scenario Matrix Slide Visual

## Prompt

```text
Create a SINGLE FLAT PRINT ARTWORK image for an executive board deck: **scenario matrix**.
...
- ZONE 2 (middle, 64% height): Main analytic visual for scenario matrix.
...
2) Clear board-slide visual for scenario matrix, not generic art.
