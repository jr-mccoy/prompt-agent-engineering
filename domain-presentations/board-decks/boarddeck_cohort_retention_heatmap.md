---
title: "Cohort Retention Heatmap Slide Visual"
category: presentations/board-decks/image-generation
description: "Constraint-locked image prompt for a board-deck cohort retention heatmap visual in 16:9 format."
techniques:
  - SV-11
  - SV-12
  - SV-13
...
# Cohort Retention Heatmap Slide Visual

## Prompt

```text
Create a SINGLE FLAT PRINT ARTWORK image for an executive board deck: **cohort retention heatmap**.
...
- ZONE 2 (middle, 64% height): Main analytic visual for cohort retention heatmap.
...
2) Clear board-slide visual for cohort retention heatmap, not generic art.
