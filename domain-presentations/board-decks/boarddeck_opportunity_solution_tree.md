---
title: "Opportunity Solution Tree Slide Visual"
category: presentations/board-decks/image-generation
description: "Constraint-locked image prompt for a board-deck opportunity solution tree visual in 16:9 format."
techniques:
  - SV-11
  - SV-12
  - SV-13
...
# Opportunity Solution Tree Slide Visual

## Prompt

```text
Create a SINGLE FLAT PRINT ARTWORK image for an executive board deck: **opportunity solution tree**.
...
- ZONE 2 (middle, 64% height): Main analytic visual for opportunity solution tree.
...
2) Clear board-slide visual for opportunity solution tree, not generic art.
