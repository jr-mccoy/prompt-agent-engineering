---
title: "Capacity Planning Grid Slide Visual"
category: presentations/board-decks/image-generation
description: "Constraint-locked image prompt for a board-deck capacity planning grid visual in 16:9 format."
techniques:
  - SV-11
  - SV-12
  - SV-13
...
# Capacity Planning Grid Slide Visual

## Prompt

```text
Create a SINGLE FLAT PRINT ARTWORK image for an executive board deck: **capacity planning grid**.
...
- ZONE 2 (middle, 64% height): Main analytic visual for capacity planning grid.
...
2) Clear board-slide visual for capacity planning grid, not generic art.
