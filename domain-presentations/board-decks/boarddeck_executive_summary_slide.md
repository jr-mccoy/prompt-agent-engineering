---
title: "Executive Summary Slide Visual"
category: presentations/board-decks/image-generation
description: "Constraint-locked image prompt for a board-deck executive summary slide visual in 16:9 format."
techniques:
  - SV-11
  - SV-12
  - SV-13
...
# Executive Summary Slide Visual

## Prompt

```text
Create a SINGLE FLAT PRINT ARTWORK image for an executive board deck: **executive summary slide**.
...
- ZONE 2 (middle, 64% height): Main analytic visual for executive summary slide.
...
2) Clear board-slide visual for executive summary slide, not generic art.
