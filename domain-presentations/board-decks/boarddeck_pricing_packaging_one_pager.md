---
title: "Pricing and Packaging One-Pager Slide Visual"
category: presentations/board-decks/image-generation
description: "Constraint-locked image prompt for a board-deck pricing-packaging one-pager visual in 16:9 format."
techniques:
  - SV-11
  - SV-12
  - SV-13
...
# Pricing and Packaging One-Pager Slide Visual

## Prompt

```text
Create a SINGLE FLAT PRINT ARTWORK image for an executive board deck: **pricing-packaging one-pager**.
...
- ZONE 2 (middle, 64% height): Main analytic visual for pricing-packaging one-pager.
...
2) Clear board-slide visual for pricing-packaging one-pager, not generic art.
