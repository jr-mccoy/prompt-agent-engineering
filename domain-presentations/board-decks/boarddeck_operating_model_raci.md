---
title: "Operating Model / RACI Slide Visual"
category: presentations/board-decks/image-generation
description: "Constraint-locked image prompt for a board-deck operating model / RACI visual in 16:9 format."
techniques:
  - SV-11
  - SV-12
  - SV-13
...
# Operating Model / RACI Slide Visual

## Prompt

```text
Create a SINGLE FLAT PRINT ARTWORK image for an executive board deck: **operating model / RACI**.
...
- ZONE 2 (middle, 64% height): Main analytic visual for operating model / RACI.
...
2) Clear board-slide visual for operating model / RACI, not generic art.
