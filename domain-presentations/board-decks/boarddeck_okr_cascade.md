---
title: "OKR Cascade Slide Visual"
category: presentations/board-decks/image-generation
description: "Constraint-locked image prompt for a board-deck OKR cascade visual in 16:9 format."
techniques:
  - SV-11
  - SV-12
  - SV-13
...
# OKR Cascade Slide Visual

## Prompt

```text
Create a SINGLE FLAT PRINT ARTWORK image for an executive board deck: **OKR cascade**.
...
- ZONE 2 (middle, 64% height): Main analytic visual for OKR cascade.
...
2) Clear board-slide visual for OKR cascade, not generic art.
