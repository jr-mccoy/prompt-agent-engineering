---
title: "Funnel Diagnostic Slide Visual"
category: presentations/board-decks/image-generation
description: "Constraint-locked image prompt for a board-deck funnel diagnostic visual in 16:9 format."
techniques:
  - SV-11
  - SV-12
  - SV-13
...
# Funnel Diagnostic Slide Visual

## Prompt

```text
Create a SINGLE FLAT PRINT ARTWORK image for an executive board deck: **funnel diagnostic**.
...
- ZONE 2 (middle, 64% height): Main analytic visual for funnel diagnostic.
...
2) Clear board-slide visual for funnel diagnostic, not generic art.
