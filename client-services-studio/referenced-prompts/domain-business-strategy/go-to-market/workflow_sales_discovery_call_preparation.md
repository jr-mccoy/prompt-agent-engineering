---
title: "Discovery Call Preparation from CRM Data"
category: business-strategy/go-to-market
description: "Turn CRM records and account research into a discovery-call plan: hypotheses to test, a question sequence, likely objections, and the qualification bar for a next step."
techniques:
  - ST-01
  - ST-02
  - CM-01
...
# Discovery Call Preparation from CRM Data
...
- **Purpose:** Prepare sales reps for discovery calls with comprehensive account research and strategic questioning framework
- **Job Family:** Sales / Account Executive
- **Workflow Stage:** Pre-discovery call preparation
- **Key Features:**
  - Account intelligence synthesis from multiple sources
  - Buyer persona analysis for each call attendee
  - Structured discovery question strategy with follow-ups
  - Objection anticipation and handling frameworks
  - Customized value propositions based on account profile
  - Time-boxed call flow structure
  - Post-call BANT qualification scoring
  - Success criteria and red flag identification
