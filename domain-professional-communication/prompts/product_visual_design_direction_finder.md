...
**When NOT to use:**
- You need the implementation-level UI look-and-feel spec (components, tokens, states) — use the sibling prompt `domain-professional-communication/design/design_frontend_look_feel_hunt.md`, which goes deeper on the build side.
