...
"I need to DESIGN an agentic system" → Go to authoring/system-patterns/SYSTEM_QUICK_START.md
```
...
| Agentic System Design Guide | `authoring/system-patterns/SYSTEM_QUICK_START.md` | Design multi-agent systems with enforced gates |
| Agentic System Factory | `agentic-system-factory/` | Guided factory: orchestrate system-patterns end-to-end |
