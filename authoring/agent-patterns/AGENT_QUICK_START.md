...
|------|-------|-----------|------|---------|
| **Critical** | Opus 4.8 | Security audits, architecture, code review, compliance | Highest | MAP-01 |
| **Balanced** | Sonnet 4.6 | Development, testing, docs, DevOps, debugging | Mid | MAP-02 |
...
**Opus 4.8** (Critical - 28% of agents)
...
**Sonnet 4.6** (Balanced - 34% of agents)
