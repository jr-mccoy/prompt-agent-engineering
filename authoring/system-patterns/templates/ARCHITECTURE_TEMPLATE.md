...
> Fill this during Steps 1–3 of [SYSTEM_QUICK_START.md](../SYSTEM_QUICK_START.md). It is the load-bearing decisions doc — the "why," not just the "what." Keep it honest: record rejected options and open questions.
