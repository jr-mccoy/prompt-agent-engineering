...
- [Business Model Canvas Analysis](../stage-4-business-model/business_model_canvas_analysis.md) - Broader business model context
- [Product-Market Fit Analysis](product_market_fit_analysis.md) - Evaluating overall market fit
- [Lean Canvas Analysis](../stage-4-business-model/lean_canvas_analysis.md) - Startup-focused business model analysis
