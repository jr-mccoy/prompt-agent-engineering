...
- `domain-engineering-workflows/tasks/task_sorting_algorithm_designer.md` — Design a new or revised algorithm.
- `domain-engineering-workflows/tasks/task_sorting_kotlin_implementation_verifier.md` — Verify the implementation of the revised design.
