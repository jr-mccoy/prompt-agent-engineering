...
Prompts for software engineering workflows including debugging, planning, design, and team processes.
...
| Prompt | When to Use |
|--------|-------------|
| `engineering_prompt_for_debugging_code.md` | Systematic debugging approach |
| `engineering_the_debugging_root_cause_mode_prompt.md` | Deep root cause analysis |
| `DEBUG_PROMPT.md` | Quick debugging template |
| `engineering_post_mortem_root_cause_ladder.md` | Incident post-mortem analysis |
...
- `engineering_prompt_for_debugging_code.md` - Systematic debugging
- `engineering_the_debugging_root_cause_mode_prompt.md` - Root cause analysis
- `DEBUG_PROMPT.md` - Quick debugging template

### Incident Response
- `engineering_post_mortem_root_cause_ladder.md` - Post-mortem framework
- `engineering_enhanced_postmortem_blueprint_with_root_cause_audit.md` - Detailed post-mortem
...
**"Debug this issue"** → `engineering_prompt_for_debugging_code.md`

**"We had an outage"** → `engineering_enhanced_postmortem_blueprint_with_root_cause_audit.md`

**"Plan the sprint"** → `engineering_delivery_sprint_planner.md`
...
- **[Done Definition](../done-definition/)** - Task completion verification
...
The engineering category focuses on software development workflows and team processes. For code-specific analysis, see the Code Analysis category.

For incident post-mortems, use `engineering_enhanced_postmortem_blueprint_with_root_cause_audit.md` for comprehensive analysis or `engineering_post_mortem_root_cause_ladder.md` for a lighter framework.
