...
- `domain-productivity/bottlenecks/bottleneck_content_audit.md` — Clean up the documentation the summary draws from.
- `domain-productivity/bottlenecks/bottleneck_knowledge_base_gap_analysis.md` — Find documentation gaps that weaken status reporting.
