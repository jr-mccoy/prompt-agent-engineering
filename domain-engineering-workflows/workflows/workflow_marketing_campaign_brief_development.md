# Campaign Brief Development from Business Goals
...
- **Purpose:** Translate business objectives into comprehensive, executable marketing campaign plans
- **Job Family:** Marketing / Campaign Management / Demand Generation
- **Workflow Stage:** Campaign planning and brief creation
- **Key Features:**
  - Business goal to marketing metric translation
  - Audience definition with demographics and psychographics
  - Multi-channel strategy with integration points
  - Phased campaign architecture (Awareness/Consideration/Decision)
  - Content calendar and creative briefs
  - Budget allocation and pacing tracking
  - Weekly optimization protocol with thresholds
