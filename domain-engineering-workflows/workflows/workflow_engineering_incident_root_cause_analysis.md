...
- **Purpose:** Conduct thorough post-incident analysis to prevent recurrence and improve system reliability
- **Job Family:** Engineering / SRE
- **Workflow Stage:** Post-incident review and system improvement planning
- **Key Features:**
  - Blameless culture focus on system improvements
  - Three-tier prevention timeline (immediate/short-term/long-term)
  - Quantified customer and business impact analysis
  - Specific action items with owners and deadlines
  - Executive and customer communication templates
  - Focus on monitoring, testing, and process gaps
