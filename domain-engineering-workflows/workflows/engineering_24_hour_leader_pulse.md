...
- Navigating internal org politics — use `engineering_stakeholder_navigation_guide.md`.
...
- `domain-engineering-workflows/workflows/engineering_stakeholder_navigation_guide.md` — Act on intelligence inside org dynamics.
...
- `domain-engineering-workflows/workflows/engineering_goal_system_designer.md` — Turn recommended actions into tracked goals.
