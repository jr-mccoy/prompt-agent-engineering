...
- `domain-engineering-workflows/improvement/improvement_refactoring.md` — Execute fixes the audit surfaces.
- `domain-engineering-workflows/workflows/coding_problems_catalog.md` — Reference taxonomy of code issues to look for.
- `domain-engineering-workflows/improvement/improvement_language_translation.md` — Ensure quality when porting to a new language.
