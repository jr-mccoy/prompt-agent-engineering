...
- ❌ Designing assessment for individual competencies (use `meded_epa_implementation_designer.md` or evidence-design prompts)
- ❌ Building CBME implementation (use `meded_cbme_implementation_program.md`)
- ❌ Building the curriculum map (use `meded_residency_curriculum_mapper.md`)
