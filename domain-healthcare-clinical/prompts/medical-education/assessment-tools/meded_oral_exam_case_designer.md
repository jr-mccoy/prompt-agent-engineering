...
updated: "2026-05-15"
related_prompts:
  - domain-healthcare-clinical/prompts/medical-education/assessment-tools/meded_nbme_style_mcq_writer.md
...
- ❌ Not for written MCQ or short answer assessments (use `meded_nbme_style_mcq_writer.md`)
