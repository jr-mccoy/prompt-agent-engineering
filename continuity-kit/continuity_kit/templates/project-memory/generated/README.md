...
|---|---|---|
| `resume-packet.md` | `continuity resume` | Bounded boot summary (3k–5k tokens) for pasting into any agent. |
| `stale-report.md` | `continuity audit` | Computed staleness / risk findings. |
| `memory-index.md` | `continuity audit` / index build | Human-readable index of records. |
