...
human–agent software work. It is managed by [`continuity-kit`](https://github.com/jr-mccoy/continuity-kit)
...
3. Review relevant records under `decisions/`, `attempts/`, `known-traps.md`, and
   `open-questions.md`.
4. If the CLI is available, run `continuity guard "<proposed action>"`.

**At session end:**

1. Run `continuity capture session` (or write a session record by hand).
