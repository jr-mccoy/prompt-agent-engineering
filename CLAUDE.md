...
- `PROMPT_INDEX.json` holds **5853 indexed artifacts**. That total is not a prompt count: it mixes the 4374 domain prompt artifacts with 10 domain slash commands, 802 agentic resources, and 667 bundled component files (a parent resource's `references/`, `assets/`, `cards/` and similar).
