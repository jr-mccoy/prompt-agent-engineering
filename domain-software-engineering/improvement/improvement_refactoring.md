...
- `domain-software-engineering/improvement/improvement_best_practice_analysis.md` — Audit to surface what needs refactoring.
- `domain-engineering-workflows/workflows/coding_problems_catalog.md` — Reference taxonomy of smells and fixes.
- `domain-software-engineering/improvement/improvement_language_translation.md` — When the cleanup is part of a language migration.
