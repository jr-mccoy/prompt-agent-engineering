...
- `domain-software-engineering/improvement/improvement_refactoring.md` — Clean up before or after translating.
- `domain-software-engineering/improvement/improvement_best_practice_analysis.md` — Verify quality of the translated target code.
