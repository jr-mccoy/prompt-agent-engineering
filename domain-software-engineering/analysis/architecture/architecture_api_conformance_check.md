---
title: "Architecture Api Conformance Check"
category: code-analysis
description: "Architecture Api Conformance Check"
tags:
  - architecture
  - code-analysis
updated: "2026-03-19"
...
**Techniques Used:**
- ST-01 (Clear Objective Statement) - Opens with clear API conformance checking objective
- ST-02 (Structured Sequential Instructions) - Numbered steps for systematic conformance verification
- DT-02 (Specific Focus Areas with Examples) - Specific verification categories (HTTP methods, parameters, request/response bodies, error handling)
- RT-05 (Evidence-Based Reasoning) - Requires specific code examples and line numbers
- DS-06 (Prioritization and Severity Guidance) - Explicitly categorizes issues as minor or major
