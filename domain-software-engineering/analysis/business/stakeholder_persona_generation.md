...
- `domain-software-engineering/analysis/business/business_impact_analysis.md` — Translate features into prioritized business value for these stakeholders.
- `domain-software-engineering/analysis/business/customer_journey_map_analysis.md` — Map how these personas move through the product.
- `domain-software-engineering/analysis/business/tech_adoption_lifecycle_analysis.md` — Position the product and its audiences in the adoption lifecycle.
