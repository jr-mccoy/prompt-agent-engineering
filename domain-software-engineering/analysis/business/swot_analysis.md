...
- [architecture_layer_identification.md](../architecture/architecture_layer_identification.md) - Deep dive on architecture strengths/weaknesses
- [evolution_technical_debt_estimation.md](../evolution/evolution_technical_debt_estimation.md) - Quantify technical debt for Weaknesses section