...
- [SWOT Analysis](swot_analysis.md) - Internal capability context for positioning
- [Value Proposition Canvas Analysis](value_proposition_canvas_analysis.md) - Customer-side of positioning
