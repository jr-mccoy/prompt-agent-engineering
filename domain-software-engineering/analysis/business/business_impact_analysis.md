...
- `domain-software-engineering/analysis/business/customer_journey_map_analysis.md` — Map code components to journey stages and user experience.
- `domain-software-engineering/analysis/business/stakeholder_persona_generation.md` — Infer the stakeholders whose value these features serve.
