...
- `domain-software-engineering/analysis/feature-design/task_sorting_algorithm_reviewer.md` — Evaluate and improve an existing algorithm.
- `domain-software-engineering/analysis/feature-design/task_sorting_kotlin_implementation_verifier.md` — Verify a Kotlin implementation of the chosen design.
