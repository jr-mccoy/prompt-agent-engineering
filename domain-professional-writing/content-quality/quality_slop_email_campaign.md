...
## Related Prompts
- `domain-professional-writing/content-quality/quality_slop_email_newsletter.md` — sibling evaluator for recurring value/relationship content (the non-conversion counterpart).
- `domain-professional-writing/content-quality/quality_slop_ad_copy.md` — sibling evaluator for paid conversion creative.
