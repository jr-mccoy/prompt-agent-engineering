...
## Related Prompts
- `domain-professional-writing/content-quality/quality_slop_email_campaign.md` — sibling evaluator for conversion-driven email sequences.
- `domain-professional-writing/content-quality/quality_slop_blog_post.md` — sibling evaluator for long-form content.
