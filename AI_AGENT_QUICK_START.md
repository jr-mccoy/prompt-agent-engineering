...
| Resource | Purpose |
|----------|---------|
| [NEW_PROMPT_TEMPLATE.md](authoring/NEW_PROMPT_TEMPLATE.md) | Copy-paste template with all required sections |
| [TECHNIQUE_PICKER_FAST.md](authoring/TECHNIQUE_PICKER_FAST.md) | Select 3–5 techniques by intent (ANALYZE, CREATE, FIX, etc.) |
| [NEW_RESOURCE_CHECKLIST.md](authoring/NEW_RESOURCE_CHECKLIST.md) | Pre-commit checklist for quality and placement |

> **Saving the prompt into this repository?** Include the YAML frontmatter block (`title`, `category`, `description`, `techniques`, `difficulty`, `tags`, `updated`, `related_prompts`) — it powers `PROMPT_INDEX.json` discovery. The block is included in [NEW_PROMPT_TEMPLATE.md](authoring/NEW_PROMPT_TEMPLATE.md); the canonical spec is in [PROMPT_QUALITY_STANDARDS.md](PROMPT_QUALITY_STANDARDS.md).
...
Skip tags when there is no injected content. Full rationale and conventions: [authoring/PROMPT_STRUCTURE_GUIDE.md](authoring/PROMPT_STRUCTURE_GUIDE.md).
...
**Solution:** Wrap the injected content in named XML-style tags (e.g. `<codebase>...</codebase>`) and reference the tag by name in the steps — see [authoring/PROMPT_STRUCTURE_GUIDE.md](authoring/PROMPT_STRUCTURE_GUIDE.md)
...
| Resource | Purpose |
|----------|---------|
| [`techniques/MASTER_TECHNIQUE_INDEX.md`](techniques/MASTER_TECHNIQUE_INDEX.md) | Complete catalog of 327 active techniques across 18 categories |
...
- **Model-optimized:** Each agent assigned optimal model (Opus 4.8 for critical work, Sonnet for balanced, Haiku for speed)
...
**Example agents:**
- `security-auditor` (Opus 4.8) - Critical security review
- `python-architect` (Sonnet 4.6) - Python development
- `frontend-developer` (Sonnet 4.6) - UI/UX implementation
...
**Model recommendation:** Opus 4.8 for critical systems
...
```markdown
**Recommended Models:**
- **Opus 4.8:** Use for architecture decisions, security audits, production code review
- **Sonnet 4.6:** Use for feature implementation, testing, documentation
...
2. **Deep dive:** Activate `security-auditor` agent (Opus 4.8) for persistent review
...
|-------|----------------|---------|----------|
| **Opus 4.8** | Highest | Critical decisions, security, architecture | `security-auditor`, `architect-review`, `code-reviewer` |
| **Sonnet 4.6** | Medium | Feature development, testing, documentation | `python-architect`, `frontend-developer`, `test-automator` |
...
**Browse by category:**
- [Agents Index](domain-agentic-resources/agents/README.md) - 158 agents across 16 categories
- [Skills Index](domain-agentic-resources/skills/README.md) - 132 skills across 21 categories
- [Commands Index](domain-agentic-resources/commands/README.md) - 71 commands across 15 categories
...
- [Updated Technique Index](techniques/MASTER_TECHNIQUE_INDEX.md) - 327 active techniques across 18 categories
