---
title: "Deep-Think (Plain English): Reviewing Something That Already Exists"
...
# Deep-Think (Plain English): Reviewing Something That Already Exists

**What this is, in one paragraph:** Evaluate an existing artifact, proposal, plan, design, document, or output at a depth that would normally require a review panel. Drive the model through five disciplined phases — Frame, Decompose criteria and evidence, Multi-perspective analysis, Stress-test, and Synthesize — pausing at each gate to let the user redirect, reprioritize, or go deeper. Produce an evaluation report that clearly separates strengths, defects, missing evidence, recommendation, confidence, and reviewer caveats.
...
**Who this is for:** Reviewers, leads, solo operators, analysts, and anyone who needs a structured, evidence-aware critique rather than a vibe-based opinion.

---

## What you'll need to tell me up front

1. **Thing being reviewed.** Paste or link the artifact, proposal, plan, design, document, output, or a concise description plus where to inspect it.
...
### Step 2 — Break the review into criteria and evidence
...
### Step 3 — Look at it from multiple viewpoints
...
### Step 4 — Stress-test the review itself
...
### Step 5 — Sum up the evaluation report
...
1. **Thing being reviewed.** Name the artifact and evaluation boundary.
2. **Review criteria and weights.** Include gating criteria and a concise score or qualitative rating by criterion.
3. **Strengths.** Evidence-backed positives, not generic praise.
4. **Problems / risks.** Evidence-backed issues, severity, and likely consequence.
