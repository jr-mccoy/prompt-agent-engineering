...
- `domain-productivity/reviews/reviews_solo_dev_weekly_operating_rhythm.md` — Scheduling contractor management time
- `domain-engineering-workflows/workflows/engineering_solo_dev_roadmap_planner.md` — Planning what to outsource within your product roadmap
