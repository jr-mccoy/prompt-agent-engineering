...
## Related Prompts
- `domain-personal-development/prompts/career/career_deep_learning_engineering.md` — deeper neural-network-focused readiness assessment.
- `domain-personal-development/prompts/career/career_computer_vision_engineering.md` — CV-specialized readiness assessment.
- `domain-personal-development/prompts/career/career_nlp_engineering.md` — NLP-specialized readiness assessment.
