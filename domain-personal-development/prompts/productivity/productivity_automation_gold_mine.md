...
- Use this when you have a **specific named workflow** to analyze. For a personal-developer-wide automation sweep, route to `solo_dev_automation_audit.md`. To clear out the unstructured mental backlog *before* deciding what's worth automating, run `productivity_open_loop_audit.md` first.
...
- [productivity_open_loop_audit.md](../productivity/productivity_open_loop_audit.md) — Identify tasks cluttering your mental space (run before deciding what to automate).
- [productivity_zombie_meeting_detector.md](../productivity/productivity_zombie_meeting_detector.md) — Automate or eliminate meeting overhead.
- [solo_dev_automation_audit.md](../solo-dev/solo_dev_automation_audit.md) — Deeper automation analysis for solo developers.

> **Boundary note:** Meeting/automation/focus overlap with [`domain-productivity/deep-work/`](../../../domain-productivity/deep-work/) (calendar audits, meeting-to-async conversion). This prompt is the personal-development entry point; link across rather than duplicating that cluster.
