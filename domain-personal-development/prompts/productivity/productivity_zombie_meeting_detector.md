...
updated: "2026-06-21"
related_prompts:
  - domain-personal-development/prompts/productivity/productivity_meeting_killer_prompt.md
...
- **Use this over its sibling `productivity_meeting_killer_prompt.md` when** you're doing **bulk triage across many recurring meetings**. Use the meeting-killer instead for a **single-meeting deep-dive** with cost math and ready-to-send communication templates.
- Don't use when: you only have one meeting in question — go straight to `productivity_meeting_killer_prompt.md`.
...
- [productivity_meeting_killer_prompt.md](../productivity/productivity_meeting_killer_prompt.md) — Sibling: deep-dive analysis of a *single* meeting (vs. this bulk calendar sweep).
- [productivity_personal_energy_audit.md](../productivity/productivity_personal_energy_audit.md) — Understand how meetings affect your energy.
- [productivity_automation_gold_mine.md](../productivity/productivity_automation_gold_mine.md) — Automate meeting-adjacent workflows.

> **Boundary note:** Calendar/meeting auditing overlaps with [`domain-productivity/deep-work/`](../../../domain-productivity/deep-work/) (e.g. `deepwork_calendar_audit.md`, `deepwork_meeting_to_async_converter.md`). This prompt is the personal-development entry point; link across rather than duplicating that cluster.
