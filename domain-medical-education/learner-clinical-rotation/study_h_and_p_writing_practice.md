...
- ❌ Active patient care
- ❌ Writing a progress note — use `study_soap_note_writing_practice.md`
...
| Nursing (admission assessment) | Functional, safety, fall risk, skin assessment, pain, nutrition screen, teaching needs; problem list is nursing-diagnosis-anchored — see `domain-medical-education/profession-specific/nursing/nursing_care_plan_practice.md` |
