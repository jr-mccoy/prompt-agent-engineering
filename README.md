...
<!-- REPO_FACTS_DECLARATION: {"active_techniques": 327, "agents": 143, "commands": 115, "domain_prompt_artifacts": 4433, "indexed_artifacts": 5912, "personas": 53, "skills": 333} -->
[![domain prompt artifacts](https://img.shields.io/badge/domain_prompt_artifacts-4433-orange.svg)](PROMPT_INDEX.md)
[![techniques](https://img.shields.io/badge/techniques-327-purple.svg)](techniques/MASTER_TECHNIQUE_INDEX.md)
[![skills](https://img.shields.io/badge/skills-333-blue.svg)](domain-agentic-resources/skills/README.md)
[![agents](https://img.shields.io/badge/agents-143-blue.svg)](domain-agentic-resources/agents/README.md)

| Registry facts | Count |
|---|---|
| Indexed domain prompt artifacts | 4433 |
...
| Total indexed artifacts (all of the above kinds mixed) | 5912 |
...
| [`domain-frontend-development/`](domain-frontend-development/) | Frontend frameworks, accessibility, performance, testing, UX research methods |
...
| [`domain-business-strategy/`](domain-business-strategy/) | Analysis, startups, research, chief-of-staff workflows, AI strategy, nonprofit, small business |
...
| [`domain-risk/`](domain-risk/) | Risk registers, FMEA, heat maps, tail risk, dependency analysis, security operations |
...
| [`domain-conversation-practice/`](domain-conversation-practice/) | Language conversation sims and hard-conversation role-play |
...
| [`domain-learning/`](domain-learning/) | Domain-general self-directed learning, humanities self-study |
...
| [`domain-specialized-fields/`](domain-specialized-fields/) | Real-estate and trades practitioner prompts, professional-field guides |
