...
the five `go-to-market/` relocations plus four new prompts (17 total).
...
```
domain-sales-customer/          17 prompts
...
└── support/            4   ticket triage and routing, escalation reply + handoff,
