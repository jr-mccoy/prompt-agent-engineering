---
title: "Health & Wellness Image Advertising Prompt Builder"
category: advertising/image-generation
description: "Interview-driven meta-prompt for generating print-safe and screen-safe advertising image prompts for health & wellness."
techniques:
  - SV-03
  - ST-02
  - SV-11
...
**Objective:** Generate a high-compliance advertising image prompt for **Health & Wellness** campaigns using an interview-first workflow and strict print/screen output constraints.

## Interview Intake (required before prompt generation)

Collect and confirm all fields before drafting the final image prompt:
1. **Product/Offer:** `fitness offer, supplement release, clinic promotion`
2. **Audience:** `health-focused adults and families`
3. **Key Message:** `Better daily energy and confidence`
4. **Palette Direction:** `clean green/white/navy palette`
5. **Primary CTA:** `Start your plan`
...
- ROLE + purpose
- campaign context for health & wellness
...
- **SV-16 Physical Context Anchoring:** include realistic usage context for health & wellness advertising collateral.
