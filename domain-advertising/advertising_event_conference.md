---
title: "Events Image Advertising Prompt Builder"
category: advertising/image-generation
description: "Interview-driven meta-prompt for generating print-safe and screen-safe advertising image prompts for events."
techniques:
  - SV-03
  - ST-02
  - SV-11
...
1. **Product/Offer:** `conference, summit, trade show campaign`
2. **Audience:** `attendees, sponsors, industry teams`
3. **Key Message:** `Must-attend networking + learning`
4. **Palette Direction:** `purple/indigo/cyan palette`
5. **Primary CTA:** `Reserve your ticket`
...
- **SV-16 Physical Context Anchoring:** include realistic usage context for events advertising collateral.
