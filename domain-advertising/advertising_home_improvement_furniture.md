---
title: "Home Improvement Image Advertising Prompt Builder"
category: advertising/image-generation
description: "Interview-driven meta-prompt for generating print-safe and screen-safe advertising image prompts for home improvement."
techniques:
  - SV-03
  - ST-02
  - SV-11
...
**Objective:** Generate a high-compliance advertising image prompt for **Home Improvement** campaigns using an interview-first workflow and strict print/screen output constraints.

## Interview Intake (required before prompt generation)

Collect and confirm all fields before drafting the final image prompt:
1. **Product/Offer:** `renovation service, furniture sale, contractor campaign`
2. **Audience:** `homeowners and remodel planners`
3. **Key Message:** `Reliable upgrade with visible value`
4. **Palette Direction:** `earth/wood/charcoal palette`
5. **Primary CTA:** `Get a free estimate`
...
- ROLE + purpose
- campaign context for home improvement
...
- **SV-16 Physical Context Anchoring:** include realistic usage context for home improvement advertising collateral.
