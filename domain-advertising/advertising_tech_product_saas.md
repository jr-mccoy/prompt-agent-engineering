---
title: "SaaS Image Advertising Prompt Builder"
category: advertising/image-generation
description: "Interview-driven meta-prompt for generating print-safe and screen-safe advertising image prompts for saas."
techniques:
  - SV-03
  - ST-02
  - SV-11
...
1. **Product/Offer:** `software launch, feature campaign, product-led ad set`
2. **Audience:** `operators, founders, technical buyers`
3. **Key Message:** `Ship faster with less manual work`
4. **Palette Direction:** `blue/violet/white palette`
...
- **SV-16 Physical Context Anchoring:** include realistic usage context for saas advertising collateral.
