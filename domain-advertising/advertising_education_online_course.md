---
title: "Education Image Advertising Prompt Builder"
category: advertising/image-generation
description: "Interview-driven meta-prompt for generating print-safe and screen-safe advertising image prompts for education."
techniques:
  - SV-03
  - ST-02
  - SV-11
...
1. **Product/Offer:** `course cohort, certification, tutoring service`
2. **Audience:** `students, career switchers, professionals`
3. **Key Message:** `Skill growth with clear outcomes`
4. **Palette Direction:** `blue/gold/white palette`
5. **Primary CTA:** `Enroll now`
...
- ROLE + purpose
- campaign context for education
...
- **SV-16 Physical Context Anchoring:** include realistic usage context for education advertising collateral.
