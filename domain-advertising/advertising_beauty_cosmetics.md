---
title: "Beauty Image Advertising Prompt Builder"
category: advertising/image-generation
description: "Interview-driven meta-prompt for generating print-safe and screen-safe advertising image prompts for beauty."
techniques:
  - SV-03
  - ST-02
  - SV-11
...
1. **Product/Offer:** `cosmetics line, skincare launch, salon campaign`
2. **Audience:** `beauty-conscious consumers, gift shoppers`
3. **Key Message:** `Confidence and routine transformation`
4. **Palette Direction:** `rose/cream/charcoal palette`
5. **Primary CTA:** `Shop the collection`
...
- **SV-16 Physical Context Anchoring:** include realistic usage context for beauty advertising collateral.
