---
title: "Premium Service Image Advertising Prompt Builder"
category: advertising/image-generation
description: "Interview-driven meta-prompt for generating print-safe and screen-safe advertising image prompts for premium service."
techniques:
  - SV-03
  - ST-02
  - SV-11
...
1. **Product/Offer:** `high-end service offering with concierge positioning`
2. **Audience:** `affluent buyers seeking premium support`
3. **Key Message:** `White-glove excellence`
4. **Palette Direction:** `black/gold/ivory palette`
5. **Primary CTA:** `Request a private consultation`
...
- ROLE + purpose
- campaign context for premium service
...
- **SV-16 Physical Context Anchoring:** include realistic usage context for premium service advertising collateral.
