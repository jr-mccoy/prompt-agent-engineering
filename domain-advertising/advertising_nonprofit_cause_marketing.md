---
title: "Nonprofit Image Advertising Prompt Builder"
category: advertising/image-generation
description: "Interview-driven meta-prompt for generating print-safe and screen-safe advertising image prompts for nonprofit."
techniques:
  - SV-03
  - ST-02
  - SV-11
...
1. **Product/Offer:** `fundraising drive, volunteer recruitment, awareness push`
2. **Audience:** `donors, volunteers, community supporters`
3. **Key Message:** `Impact per contribution`
4. **Palette Direction:** `hopeful blue/orange palette`
5. **Primary CTA:** `Donate today`
...
- ROLE + purpose
- campaign context for nonprofit
...
- **SV-16 Physical Context Anchoring:** include realistic usage context for nonprofit advertising collateral.
