---
title: "Food & Beverage Image Advertising Prompt Builder"
category: advertising/image-generation
description: "Interview-driven meta-prompt for generating print-safe and screen-safe advertising image prompts for food & beverage."
techniques:
  - SV-03
  - ST-02
  - SV-11
...
1. **Product/Offer:** `menu launch, packaged product, cafe campaign`
2. **Audience:** `hungry locals, grocery buyers, food explorers`
3. **Key Message:** `Flavor and immediacy`
4. **Palette Direction:** `warm amber/green/cream palette`
5. **Primary CTA:** `Order now`
...
- ROLE + purpose
- campaign context for food & beverage
...
- **SV-16 Physical Context Anchoring:** include realistic usage context for food & beverage advertising collateral.
