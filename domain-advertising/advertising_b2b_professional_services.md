---
title: "B2B Services Image Advertising Prompt Builder"
category: advertising/image-generation
description: "Interview-driven meta-prompt for generating print-safe and screen-safe advertising image prompts for b2b services."
techniques:
  - SV-03
  - ST-02
  - SV-11
...
**Objective:** Generate a high-compliance advertising image prompt for **B2B Services** campaigns using an interview-first workflow and strict print/screen output constraints.

## Interview Intake (required before prompt generation)

Collect and confirm all fields before drafting the final image prompt:
1. **Product/Offer:** `consulting, managed services, enterprise support`
2. **Audience:** `operations leaders, procurement, IT directors`
3. **Key Message:** `Reduce risk and save time`
4. **Palette Direction:** `navy/slate/teal palette`
5. **Primary CTA:** `Schedule a discovery call`
...
- ROLE + purpose
- campaign context for b2b services
...
- **SV-16 Physical Context Anchoring:** include realistic usage context for b2b services advertising collateral.
