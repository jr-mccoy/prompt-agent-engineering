...
## Related Prompts
- `domain-productivity/validation/quality_slop_blog_post.md` — sibling evaluator for long-form content credibility.
- `domain-productivity/validation/quality_slop_client_deliverable.md` — sibling evaluator for actionable, evidence-backed deliverables.
