...
## Related Prompts
- `domain-productivity/validation/quality_slop_case_study.md` — sibling evaluator focused on proof-heavy customer stories.
- `domain-productivity/validation/quality_slop_email_newsletter.md` — sibling evaluator for recurring content value.
