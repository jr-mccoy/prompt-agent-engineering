...
## Related Prompts
- `domain-productivity/validation/quality_slop_email_campaign.md` — sibling evaluator for conversion-driven sends (the action-oriented counterpart).
- `domain-productivity/validation/quality_slop_blog_post.md` — sibling evaluator for long-form value content.
