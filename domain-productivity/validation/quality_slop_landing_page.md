...
updated: "2026-06-19"
related_prompts:
  - domain-productivity/validation/quality_slop_product_description.md
...
## Related Prompts
- `domain-productivity/validation/quality_slop_product_description.md` — sibling detector for product/listing copy.
