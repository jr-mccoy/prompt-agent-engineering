...
updated: "2026-06-19"
related_prompts:
  - domain-productivity/validation/quality_slop_meeting_summary.md
...
## Related Prompts
- `domain-productivity/validation/quality_slop_meeting_summary.md` — sibling detector for meeting recaps.
