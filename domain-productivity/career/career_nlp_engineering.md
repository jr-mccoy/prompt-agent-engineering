...
updated: "2026-06-19"
related_prompts:
  - domain-productivity/career/career_ml_engineering.md
...
## Related Prompts
- `domain-productivity/career/career_ml_engineering.md` — adjacent assessment; a common bridge role into NLP.
- `domain-productivity/career/career_deep_learning_engineering.md` — overlapping deep-learning depth assessment.
- `domain-productivity/career/career_computer_vision_engineering.md` — sibling specialized-ML readiness assessment.
