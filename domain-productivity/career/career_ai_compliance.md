...
related_prompts:
  ...
  - domain-productivity/career/career_ai_governance.md
---
...
- `domain-productivity/career/career_ai_governance.md` — the closely adjacent AI Governance Specialist assessment.
