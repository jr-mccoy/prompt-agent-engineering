...
## Related Prompts
- `domain-productivity/career/career_ml_engineering.md` — adjacent assessment; a common bridge role into DL.
- `domain-productivity/career/career_computer_vision_engineering.md` — overlapping CV-specialized depth assessment.
- `domain-productivity/career/career_nlp_engineering.md` — sibling specialized-ML readiness assessment.
