...
related_prompts:
  ...
  - domain-productivity/career/career_ai_compliance.md
---
...
- `domain-productivity/career/career_ai_compliance.md` — the closely adjacent AI Compliance Manager assessment.
