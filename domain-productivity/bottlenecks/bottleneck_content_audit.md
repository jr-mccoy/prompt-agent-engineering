...
- `domain-productivity/bottlenecks/bottleneck_knowledge_base_gap_analysis.md` — Find what's missing rather than what's cluttered.
- `domain-engineering-workflows/workflows/engineering_project_status_summary.md` — Pull scattered docs into a single status snapshot.
- `domain-professional-writing/writing/writing_content_research.md` — Gather and organize source material for new content.
