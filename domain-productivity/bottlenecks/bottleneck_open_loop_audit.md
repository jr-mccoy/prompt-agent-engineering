...
- Don't use when: you already have a clean list and just need to schedule it against your energy — use `domain-productivity/deep-work/deepwork_personal_energy_audit.md`.
...
- [domain-productivity/deep-work/deepwork_personal_energy_audit.md](../deep-work/deepwork_personal_energy_audit.md) — Optimize *when* you tackle these tasks.
- [domain-productivity/automation/automation_gold_mine.md](../automation/automation_gold_mine.md) — Automate recurring tasks from your list.
- [agency_next_action_spec.md](../../domain-personal-development/prompts/agency/agency_next_action_spec.md) — Turn a top item into one keystroke-level next action.
- [agency_planning_masquerade_detector.md](../../domain-personal-development/prompts/agency/agency_planning_masquerade_detector.md) — Check whether the "tasks" are planning-as-avoidance.
