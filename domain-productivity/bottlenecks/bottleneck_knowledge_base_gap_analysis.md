...
updated: "2026-06-07"
related_prompts:
  - domain-productivity/bottlenecks/bottleneck_content_audit.md
...
- `domain-productivity/bottlenecks/bottleneck_content_audit.md` — Declutter existing content rather than find what's missing.
- `domain-engineering-workflows/workflows/engineering_project_status_summary.md` — Synthesize scattered docs into a status snapshot.
- `domain-professional-writing/writing/writing_content_research.md` — Gather source material to fill identified gaps.
