...
- `domain-productivity/prototyping/prototyping_event_registration.md` — Pair the page with a real signup flow.
- `domain-productivity/prototyping/prototyping_personal_crm.md` — Where captured leads/contacts could later live.
- `domain-productivity/prototyping/prototyping_habit_tracker.md` — Build the product the page promotes.
