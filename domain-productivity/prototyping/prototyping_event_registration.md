...
updated: "2026-06-07"
related_prompts:
  - domain-productivity/prototyping/prototyping_landing_page.md
...
- `domain-productivity/prototyping/prototyping_landing_page.md` — Pair a marketing page with the registration flow.
- `domain-productivity/prototyping/prototyping_request_management.md` — Similar public-form + admin-table pattern for intake.
- `domain-productivity/prototyping/prototyping_inventory_tracker.md` — Shared list/detail/export CRUD structure.
