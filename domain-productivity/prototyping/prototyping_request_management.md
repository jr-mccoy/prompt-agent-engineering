...
updated: "2026-06-07"
related_prompts:
  - domain-productivity/prototyping/prototyping_event_registration.md
  - domain-productivity/prototyping/prototyping_inventory_tracker.md
...
- `domain-productivity/prototyping/prototyping_event_registration.md` — Same public-form + gated-admin pattern.
- `domain-productivity/prototyping/prototyping_inventory_tracker.md` — Shared list/detail/filter/export CRUD structure.
- `domain-productivity/prototyping/prototyping_personal_crm.md` — Local-first record management with status/urgency views.
