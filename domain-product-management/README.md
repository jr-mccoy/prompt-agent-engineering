# Professional Communication: Comprehensive Guide

> Part of the [Non-Coding Quick Start](../NON_CODING_QUICK_START.md) system.
> This domain covers business documents, stakeholder communication, presentations, proposals, PRDs, and organizational communication.
...
> **Note:** This domain does not yet ship standalone prompt files for every product- and design-communication topic — notably competitive analysis, stakeholder navigation, and design-direction work.

For those, use the templates below (Executive Proposal, PRD skeleton, and others in this README) directly, or adapt related prompts from:
- [`domain-business-strategy/analysis/`](../domain-business-strategy/analysis/) — strategic frameworks
- [`domain-business-strategy/research/`](../domain-business-strategy/research/) — competitive / company research
- [`domain-engineering-workflows/workflows/`](../domain-engineering-workflows/workflows/) — sprint planning and delivery
...
| [prompts/](./prompts/) | All product prompts (consolidated here) |
| [design/](./design/) | Design-related prompts |
| [domain-business-strategy/](../domain-business-strategy/) | Business analysis prompts |
| [domain-presentations/](../domain-presentations/) | Presentation prompts |
