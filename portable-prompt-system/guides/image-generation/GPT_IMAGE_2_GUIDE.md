...
> **Portable-bundle note:** Cross-references in this guide to `IMAGE_PROMPTING_GUIDE.md` and the `gpt-image-2/` prompt set point at the *source* library and are **not** bundled. The two image guides included here are this file and [`IMAGE_GENERATION_GUIDE.md`](IMAGE_GENERATION_GUIDE.md); technique references resolve to [`../../techniques/MASTER_TECHNIQUE_INDEX.md`](../../techniques/MASTER_TECHNIQUE_INDEX.md).
...
- **[IMAGE_PROMPTING_GUIDE.md](../../../domain-image-generation/IMAGE_PROMPTING_GUIDE.md)** — Cross-model image prompting reference.
...
- **[gpt-image-2/](../../../domain-image-generation/gpt-image-2/)** — 12 production-ready prompts that apply this guide.
...
Per OpenAI's official guide, the following patterns are battle-tested. Each maps to a prompt in [`gpt-image-2/`](../../../domain-image-generation/gpt-image-2/).
...
- **gpt-image-2/README.md** — Index of 12 production prompts that apply this guide.
- **[IMAGE_PROMPTING_GUIDE.md](../../../domain-image-generation/IMAGE_PROMPTING_GUIDE.md)** — Cross-model image prompting reference.
- **[IMAGE_GENERATION_GUIDE.md](IMAGE_GENERATION_GUIDE.md)** — Print-ready material constraints (the 8 SV techniques).
