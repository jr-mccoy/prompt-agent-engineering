...
>
> **For image generation prompts:** See [image-generation/IMAGE_GENERATION_GUIDE.md](image-generation/IMAGE_GENERATION_GUIDE.md) - Image generation prompts require fundamentally different techniques (grid forcing, constraint redundancy, terminology steering) that are not covered here.
>
> **Creating a new resource?** Use the [Authoring Toolkit](NEW_PROMPT_TEMPLATE.md): template, technique picker, and checklist.
...
| **Specialized Fields** | [domain-specialized-fields/](../../domain-specialized-fields/) | Legal, finance, trades, real estate, marketing | Field-specific norms, regulations, terminology |
...
| [image-generation/IMAGE_GENERATION_GUIDE.md](image-generation/IMAGE_GENERATION_GUIDE.md) | Image generation prompt building (badge buddies, infographics, diagrams) |
