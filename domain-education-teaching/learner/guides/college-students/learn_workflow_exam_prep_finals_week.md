...
- Undergrad or grad student preparing for a high-stakes exam (midterm, final, comprehensive)
- Finals week with multiple exams in 5–10 days
- Course material has accumulated and you need a study system, not just more reading

## What You'll Have at the End

- A triage matrix (which exams matter most, which are hardest, when they fall)
- A study schedule that fits the time available
- A working spaced-retrieval system for the highest-stakes content
- A reviewed mistake log so you don't re-make the same errors
- A test-day strategy calibrated to the exam format and your anxiety profile

## What You Need to Bring

- All exam dates, formats (multiple choice, essay, problem-set, mixed), and weights as % of final grade
- Your accumulated course notes, mistakes from earlier quizzes / problem sets, study guides if provided
- An honest read on your current state per course (what's solid, what's shaky)
- 6–20 hours over 1–2 weeks (depending on number of exams and current state)
...
**What you'll get:** triage matrix (weight × difficulty × deadline), session goals per course, buffer time

**Carry forward:** the schedule

**Time:** 45–90 min

**Use this even for a single exam** — the prompt scales down; the triage thinking is what you want.
...
**What you'll get:** what's eating focus time you thought you had; which commitments to cancel, defer, or shorten

**Carry forward:** a real picture of available study hours

**Time:** 20–30 min

**Why this matters:** the schedule from step 1 assumes a number of available hours. Step 2 corrects that assumption against reality.

### Stage 2: Active Recall System (Days 2–4)
...
**What you'll get:** multi-level active-recall questions (definition / understanding / application / synthesis) you can use for spaced retrieval

**Carry forward:** a question bank per course

**Time:** 60–90 min per course (4 courses = 4–6 hours total)

**Don't skip to flashcards.** The act of building the questions is itself studying.
...
**What you'll get:** prompts that lead you to identify main points, generate cue questions, write a summary from memory

**Skip if:** your notes are already organized and you can find specific concepts quickly.

**Time:** 90–120 min for the worst course

### Stage 3: Mistake Review (Day 5)
...
**What you'll get:** patterns across your mistakes — same misconception, same procedural error, same time-pressure failure — and prioritized practice targets

**Carry forward:** the 3–5 specific errors most likely to cost you points on the exam

**Time:** 90 min

**This is the highest-leverage step in the workflow.** Most students study what they already know. Mistake-log review forces practice on what you don't.
...
### Stage 4: Teach-Back and Final Practice (Days 6–7)
...
**What you'll get:** teach-back probe that surfaces gaps — AI never explains the concept; you do the explaining and discover what you don't actually know

**Carry forward:** sharper understanding of 1–3 wobbliest topics
...
**What you'll get:** direct test-day strategy — time-per-question, what to do first, what to skip first, anxiety reset protocols if needed

**Time:** 15–30 min the day before each exam

**This step is direct-mode, not Socratic.** The day before an exam is not the time for diagnostic questions; it's the time for clear instructions.
...
|-------|-------|------:|
| Triage | 1–2 | 1–2 |
| Active recall build | 3–4 | 4–8 |
| Mistake review | 5–6 | 3.5–5.5 |
| Teach-back | 7 | 1–2 |
| Test day | 8 | 0.5–1 per exam |
| **Total for 1 exam** | | **6–10** |
| **Total for finals week (4 exams)** | | **10–20** |

## When to Skip Steps

| Situation | Skip / modify |
|-----------|---------------|
| Single exam | Run step 1 lightly; otherwise full chain |
...
| Failure | What to do |
|---------|-----------|
| **Re-reading notes for hours and feeling productive.** | Re-reading is not studying. Move to step 3 immediately. The active-recall question bank is the highest-yield use of study hours. |
...
If exam-week prep is consistently chaotic, the fix is during the semester:
