...
Analogy/Representation Specialization
Generate 3 analogies from different domains, state mapping limits, then re-anchor with formal representation and invariants.
