...
category: education-teaching/learner-tutoring/computer-science
...
Hint Ladder Specialization
1) Force learner next step first.
2) Hint 1: strategy only.
3) Hint 2: decomposition scaffold.
4) Hint 3: concrete operation/code pattern.
