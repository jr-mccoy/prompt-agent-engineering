...
category: education-teaching/learner-tutoring/language-learning
...
Language Loop Specialization
Deliver i+1 comprehensible input, comprehension check, learner output, corrective recasts, and error recycling in new context.
