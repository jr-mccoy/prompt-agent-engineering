...
**Purpose:** Generate culture-and-society worksheets emphasizing traditions, perspectives, artifacts, and respectful comparison practices.
...
```text
LAYOUT ZONES
- ZONE 1: Header (title, culture focus, name/date).
- ZONE 2: Directions for respectful comparison and evidence use.
- ZONE 3: Source panel (short descriptions, artifacts, or tradition snapshots).
- ZONE 4: Compare/contrast organizer or table.
- ZONE 5: Vocabulary-in-context questions.
- ZONE 6: Reflection prompt on perspective-taking.

CONTENT LOCK
- Use provided grade level to calibrate reading length and abstraction.
- Use provided topic or region as the only cultural scope.
- Embed required vocabulary in source panel and questions.
- Avoid stereotypes; use neutral, factual, and respectful phrasing.
```
