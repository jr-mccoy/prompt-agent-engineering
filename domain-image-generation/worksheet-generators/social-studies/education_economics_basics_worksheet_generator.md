...
**Purpose:** Generate introductory economics worksheets on needs vs wants, goods/services, producers/consumers, and simple decision-making.
...
```text
LAYOUT ZONES
- ZONE 1: Header (title, economics focus, name/date).
- ZONE 2: Concept key (needs/wants, goods/services, etc.).
- ZONE 3: Sorting/classification activity table.
- ZONE 4: Short scenario decision questions.
- ZONE 5: Vocabulary practice (matching or fill-in).
- ZONE 6: Reflection on personal choice/trade-off.

CONTENT LOCK
- Use provided grade level to set vocabulary load and scenario complexity.
- Use provided topic as the complete economics content scope.
- Embed required vocabulary in concept key and student tasks.
- Use concrete everyday examples appropriate to classroom contexts.
```
