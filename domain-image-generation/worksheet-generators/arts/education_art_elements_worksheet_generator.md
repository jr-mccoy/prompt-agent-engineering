...
**Purpose:** Generate visual arts worksheets focused on line, shape, texture, value, form, color (B/W-safe adaptation), and space.
...
```text
LAYOUT ZONES
- ZONE 1: Header (title, grade, element focus, name/date).
- ZONE 2: Vocabulary bank with concise definitions.
- ZONE 3: Identify-the-element mini examples panel.
- ZONE 4: Analyze-and-label section (student marks where element appears).
- ZONE 5: Create section with boxed drawing tasks.
- ZONE 6: Reflection prompt lines.
