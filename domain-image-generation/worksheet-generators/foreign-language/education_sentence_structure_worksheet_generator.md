...
**Purpose:** Generate beginner foreign-language sentence-structure worksheets with word-order practice and scaffolded sentence building.
...
```text
LAYOUT ZONES
- ZONE 1: Header (title, target language, pattern focus, name/date).
- ZONE 2: Sentence pattern guide (subject + verb + object etc.).
- ZONE 3: Unscramble sentence strips.
- ZONE 4: Fill-in-the-blank sentence frames.
- ZONE 5: Build-your-own sentence box with word bank.
- ZONE 6: Accuracy checklist.
