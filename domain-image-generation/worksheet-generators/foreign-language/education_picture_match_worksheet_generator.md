...
**Purpose:** Generate beginner foreign-language worksheets where learners match target-language words to pictures and categories.
...
```text
LAYOUT ZONES
- ZONE 1: Header (title, target language, theme, name/date).
- ZONE 2: Pronunciation-friendly word bank (as provided).
- ZONE 3: Picture-to-word matching section.
- ZONE 4: Category sort (food/animals/actions etc.).
- ZONE 5: Label-the-picture mini set.
- ZONE 6: Exit recall check.
