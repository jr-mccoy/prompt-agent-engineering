...
**Purpose:** Generate number-sense worksheets focused on place value, comparison, ordering, and number lines.

**Required intake:** Grade level, number range, number sense objectives, vocabulary, and question count.
...
- ZONE 2: Place value mini-chart.
- ZONE 3: Compare/order problems.
- ZONE 4: Number line tasks.
- ZONE 5: Expanded/standard form tasks.
- ZONE 6: Explain-your-thinking lines.
