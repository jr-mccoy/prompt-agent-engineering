...
**Purpose:** Generate music worksheets that classify instruments into strings, woodwinds, brass, percussion, and keyboard families.
...
```text
LAYOUT ZONES
- ZONE 1: Header (title, skill, name/date).
- ZONE 2: Family definitions mini chart.
- ZONE 3: Picture/name to family matching table.
- ZONE 4: Sort-and-label section (cut-free by writing letters).
- ZONE 5: Compare-two-instruments prompt lines.
- ZONE 6: Quick quiz strip.
