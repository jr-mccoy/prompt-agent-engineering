...
**Purpose:** Generate early-childhood letter recognition worksheets with uppercase/lowercase matching and initial-sound picture cues.
...
```text
LAYOUT ZONES
- ZONE 1: Header (title, target letters, name/date).
- ZONE 2: Directions with one model item.
- ZONE 3: Letter hunt grid (target vs distractor letters).
- ZONE 4: Uppercase-lowercase match section.
- ZONE 5: Picture-to-initial-letter match strip.
- ZONE 6: Trace target letters area.
