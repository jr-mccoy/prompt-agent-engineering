...
**Purpose:** Generate grammar worksheets with sentence editing, parts of speech, and usage conventions practice.

**Required intake:** Grade level, grammar skills, target vocabulary/sentences, and number of items.
...
```text
LAYOUT ZONES
- ZONE 1: Header and conventions target.
- ZONE 2: Rule reminder box with examples.
- ZONE 3: Identify/circle section.
- ZONE 4: Edit-and-rewrite section.
- ZONE 5: Sentence combining section.
- ZONE 6: Reflection "what rule did you use?" lines.
