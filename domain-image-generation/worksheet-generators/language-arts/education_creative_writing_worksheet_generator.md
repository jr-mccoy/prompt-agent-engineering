...
**Purpose:** Generate creative-writing worksheets with prompts, planning scaffolds, and drafting lines.

**Required intake:** Grade level, writing genre, topic/theme, vocabulary targets, and support level.
...
```text
LAYOUT ZONES
- ZONE 1: Header and genre target.
- ZONE 2: Prompt choices (3 concise prompts).
- ZONE 3: Planning organizer (characters/setting/problem or claim/reasons).
- ZONE 4: Transition/vocabulary bank.
- ZONE 5: Drafting lines (ample space).
- ZONE 6: Revision checklist.
