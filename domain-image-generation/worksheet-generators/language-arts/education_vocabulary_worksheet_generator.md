...
**Purpose:** Generate vocabulary practice worksheets including definitions, context clues, and usage tasks.

**Required intake:** Grade level, vocabulary list, domain/topic, and practice format preferences.
...
```text
LAYOUT ZONES
- ZONE 1: Header and learning target.
- ZONE 2: Word list + syllable marks column.
- ZONE 3: Definition match section.
- ZONE 4: Context-clue sentence completion.
- ZONE 5: Word usage writing lines.
- ZONE 6: Self-check checklist.
