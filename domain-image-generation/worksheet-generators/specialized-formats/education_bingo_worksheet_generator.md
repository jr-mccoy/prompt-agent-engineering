...
**Purpose:** Generate educational bingo worksheets with printable call-card support and monochrome-safe board layout.
...
- ZONE 2: Directions for gameplay or independent completion.
- ZONE 3: 5x5 bingo grid with center free space (or grade-adjusted grid size).
- ZONE 4: Term/definition bank aligned to cells.
- ZONE 5: Call-card strip area or teacher call list.
- ZONE 6: Exit-ticket reflection box.

CONTENT LOCK
- Use provided grade level to adjust vocabulary density and cell text length.
- Use provided topic as the sole board content scope.
- Embed required vocabulary in cells and/or call list.
- Ensure each bingo cell is large enough for pencil marks.
```
