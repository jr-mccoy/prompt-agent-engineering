...
**Purpose:** Generate diagram-based science worksheets with label banks, arrows, and structured observation prompts.

**Required intake:** Grade level, science topic, required diagram parts, vocabulary, and complexity.
...
```text
LAYOUT ZONES
- ZONE 1: Header and objective.
- ZONE 2: Main science diagram frame.
- ZONE 3: Label bank and arrows.
- ZONE 4: Function/explanation prompts.
- ZONE 5: Compare-two-parts mini-table.
- ZONE 6: Vocabulary application sentence.
