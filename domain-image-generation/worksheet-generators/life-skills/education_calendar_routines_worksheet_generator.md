...
**Purpose:** Generate life-skills worksheets for calendar literacy, sequencing routines, and planning weekly tasks.
...
- ZONE 2: Month/week vocabulary bank.
- ZONE 3: Calendar grid questions (date/day before/after).
- ZONE 4: Sequence a daily routine steps activity.
- ZONE 5: Weekly planning table (school/home tasks).
- ZONE 6: Reflection: one routine goal.
