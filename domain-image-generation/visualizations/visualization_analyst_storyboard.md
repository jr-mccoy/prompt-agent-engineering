...
**Purpose:** Produce one clean visualization prompt for analyst use, with strict anti-mockup constraints and print/screen-safe clarity.

**Required intake:** KPI trend, drivers, comparison groups, required metric definitions, and decision question.
...
- ZONE 1: Metric header with time window and units.
- ZONE 2: Main chart region (bar/line/scatter per data type).
- ZONE 3: Driver breakdown panel with ranked contributors.
- ZONE 4: Risks/assumptions callouts (max 3).
- ZONE 5: Recommendation box with confidence score.
