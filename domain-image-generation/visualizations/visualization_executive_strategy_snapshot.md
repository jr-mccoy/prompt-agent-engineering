...
**Purpose:** Produce one clean visualization prompt for executive use, with strict anti-mockup constraints and print/screen-safe clarity.

**Required intake:** Business objective, timeline, key bets, dependencies, and KPI success criteria.
...
- ZONE 1: Strategic objective headline + timeframe.
- ZONE 2: Initiative portfolio matrix (impact vs effort).
- ZONE 3: Dependency and sequencing timeline.
- ZONE 4: KPI scoreboard with targets.
- ZONE 5: Decision asks and owner assignments.
