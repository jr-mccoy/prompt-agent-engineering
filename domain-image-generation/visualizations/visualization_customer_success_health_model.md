...
**Purpose:** Produce one clean visualization prompt for customer success use, with strict anti-mockup constraints and print/screen-safe clarity.

**Required intake:** Account segments, health signals, lifecycle stages, risk flags, and retention goal.
...
- ZONE 1: Segment + retention objective.
- ZONE 2: Health score component model.
- ZONE 3: Lifecycle journey status chart.
- ZONE 4: Risk triggers and playbooks.
- ZONE 5: Expansion and renewal action list.
