...
**Purpose:** Produce one clean visualization prompt for strategy use, with strict anti-mockup constraints and print/screen-safe clarity.

**Required intake:** Decision context, strategic options, evaluation criteria, constraints, and recommendation lens.
...
- ZONE 1: Decision statement and constraints.
- ZONE 2: Option comparison matrix.
- ZONE 3: Scenario sensitivity panel.
- ZONE 4: Risk/opportunity heatmap.
- ZONE 5: Preferred path + trigger conditions.
