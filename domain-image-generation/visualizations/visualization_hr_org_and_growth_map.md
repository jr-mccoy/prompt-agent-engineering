...
**Purpose:** Produce one clean visualization prompt for hr use, with strict anti-mockup constraints and print/screen-safe clarity.

**Required intake:** Current team structure, role families, leveling model, growth paths, and hiring priorities.
...
- ZONE 1: Team purpose and planning horizon.
- ZONE 2: Org structure bands with role families.
- ZONE 3: Career ladder progression states.
- ZONE 4: Capability gaps + hiring plan.
- ZONE 5: Mobility and development actions.
