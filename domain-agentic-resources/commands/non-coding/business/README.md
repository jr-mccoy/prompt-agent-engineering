...
## Scope
This folder contains non-coding command resources for business workflows.
...
Business resources that are regulated/compliance-sensitive must set:

```yaml
policy_overlay: regulated_business_overlay
```

See `documentation/policies/regulated_business_overlay.md` for mandatory behavior.
