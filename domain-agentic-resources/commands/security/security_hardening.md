...
version: "1.0.0"
category: security
tags: [ai, api, audit, aws, backend, ci/cd, documentation, frontend]
agents_used: [backend-architect, backend-security-coder, deployment-engineer, devops-troubleshooter, domain-specific, frontend-security-coder, mobile-security-coder, security-auditor]
---
