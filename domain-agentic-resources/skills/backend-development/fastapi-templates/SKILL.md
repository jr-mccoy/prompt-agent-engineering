...
JWT authentication with `OAuth2PasswordBearer` and `Depends`-based current user extraction, plus async test patterns with pytest-asyncio and an in-memory SQLite database.

See [references/auth-and-testing.md](references/auth-and-testing.md)

## Resources

- **references/auth-and-testing.md**: JWT auth implementation and async test setup
