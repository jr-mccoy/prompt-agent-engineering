...
Common Patterns (Pattern 1: Stateless Web App, Pattern 2: Stateful Database, Pattern 3: Background Job/Cron, Pattern 4: Multi-Container Pod), Troubleshooting (pods not starting, service not accessible, ConfigMap/Secret not loading), and Next Steps are in the reference file.

See [references/patterns-and-troubleshooting.md](references/patterns-and-troubleshooting.md)
...
| Resource | Purpose |
|----------|---------|
| `references/patterns-and-troubleshooting.md` | Common Patterns (Stateless Web App, Stateful DB, Background Job, Multi-Container Pod), Troubleshooting (pods not starting, service not accessible, ConfigMap/Secret), Next Steps after creating manifests |
