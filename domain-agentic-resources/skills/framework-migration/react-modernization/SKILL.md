...
Codemods for Automation (jscodeshift, custom codemod example), Performance Optimization (useMemo/useCallback, code splitting with lazy), TypeScript Migration (typed props, generic components), and the Migration Checklist (pre-migration, class→hooks, React 18 upgrade, performance, testing) are in the reference file.

See [references/codemods-performance-typescript-checklist.md](references/codemods-performance-typescript-checklist.md)
...
| Resource | Purpose |
|----------|---------|
| `references/codemods-performance-typescript-checklist.md` | Codemods (jscodeshift + custom codemod example), Performance Optimization (useMemo/useCallback + code splitting), TypeScript Migration (typed props + generic components), Migration Checklist (pre-migration + class→hooks + React 18 upgrade + performance + testing) |
