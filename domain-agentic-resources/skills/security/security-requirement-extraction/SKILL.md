...
## Compliance Mapping, User Story Generator, Best Practices & Resources

ComplianceMapper with FRAMEWORK_CONTROLS covering PCI-DSS/HIPAA/GDPR/OWASP (map_requirement_to_compliance, get_requirements_for_control, generate_compliance_matrix, gap_analysis identifying missing/weak controls), SecurityUserStoryGenerator with STORY_TEMPLATES by domain (generate_story with full Definition of Done + traceability, generate_epic with business value and risk sections), Best Practices (Do's/Don'ts), Resources (OWASP ASVS/NIST SP 800-53/Security User Stories).

See [references/compliance-mapping-and-user-stories.md](references/compliance-mapping-and-user-stories.md)
...
| Resource | Purpose |
|----------|---------|
| `references/compliance-mapping-and-user-stories.md` | ComplianceMapper, SecurityUserStoryGenerator, best practices, resources |
