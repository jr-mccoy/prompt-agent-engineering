...
Async streams with `async-stream` and `StreamExt`, and connection pool implementation with `Semaphore` and `RwLock`.

See [references/streams-and-resource-management.md](references/streams-and-resource-management.md)
