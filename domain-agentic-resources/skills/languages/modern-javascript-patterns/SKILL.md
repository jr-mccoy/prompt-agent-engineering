...
Array methods (map/filter/reduce/flatMap), higher-order functions (currying, partial application, memoization), function composition/piping, pure functions and immutability, modern class features (private fields, static methods), ES6 modules, iterators/generators, modern operators (optional chaining, nullish coalescing, logical assignment), and performance utilities (debounce, throttle, lazy evaluation).

See [references/functional-and-advanced-patterns.md](references/functional-and-advanced-patterns.md)
