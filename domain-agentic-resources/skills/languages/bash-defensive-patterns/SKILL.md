...
Named parameter parsing for functions and runtime dependency checking.

See [references/advanced-defensive-techniques.md](references/advanced-defensive-techniques.md)
