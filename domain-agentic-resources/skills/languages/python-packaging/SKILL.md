...
## Building, Publishing, and Advanced Patterns

Building locally, publishing to PyPI/TestPyPI, automated GitHub Actions workflows, data files, namespace packages, C extensions, version management (semantic + git-based), editable installs, README template, multi-arch wheels, private indexes, .gitignore template, MANIFEST.in, and publishing checklist.

See [references/publishing-and-advanced-patterns.md](references/publishing-and-advanced-patterns.md)
