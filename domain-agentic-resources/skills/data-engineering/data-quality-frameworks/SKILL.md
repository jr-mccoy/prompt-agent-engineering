...
## Data Contracts, Automated Pipeline, and Best Practices

Data Contract YAML spec (apiVersion/kind/metadata/servers/terms/schema with PII flags/quality SodaCL checks/SLA freshness+availability+latency), DataQualityPipeline class (QualityResult dataclass; validate_table with checkpoint config; run_all iterating tables; generate_report with pass/fail markdown summary), best practices (test early/incrementally/document/alert/version contracts; don't test everything/ignore warnings/skip freshness/hardcode thresholds/test in isolation), and external resources links.

See [references/data-contracts-and-pipeline.md](references/data-contracts-and-pipeline.md)
...
| Resource | Purpose |
|----------|---------|
| `references/data-contracts-and-pipeline.md` | Data Contract YAML spec, DataQualityPipeline class, best practices, external resources |
