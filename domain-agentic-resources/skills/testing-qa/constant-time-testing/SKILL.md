...
Implementation Guide (4 phases: Initial Assessment, Detailed Analysis, Remediation, Continuous Monitoring), Secret-Dependent Branch deep dive with dudect/Timecop code, Case Studies (OpenSSL RSA Timing Attack, KyberSlash), and Advanced Usage (Tips & Tricks, Common Mistakes tables) are in the reference file.

See [references/implementation-case-studies-advanced.md](references/implementation-case-studies-advanced.md)
...
| Resource | Purpose |
|----------|---------|
| `references/implementation-case-studies-advanced.md` | Implementation Guide (4 phases: Initial Assessment, Detailed Analysis, Remediation, CI Monitoring), Secret-Dependent Branch deep dive with dudect/Timecop harness code, Case Studies (OpenSSL RSA, KyberSlash), Advanced Usage (Tips & Tricks + Common Mistakes tables) |
