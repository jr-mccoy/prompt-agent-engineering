...
- Writing E2E test code in Playwright or Cypress (use `e2e-testing-patterns`)
- Debugging flaky tests or framework-specific issues (use `e2e-testing-patterns`)
- Implementing page object models, fixtures, or custom commands (use `e2e-testing-patterns`)
- Troubleshooting CI/CD test pipeline configuration (use `e2e-testing-patterns`)
- Android-specific testing (use `android-testing-patterns`, `android-screenshot-testing`, or `android-accessibility-testing`)
...
- `e2e-testing-patterns` - Complementary skill for implementing E2E test code in Playwright/Cypress. This skill defines *what* to test (test cases, strategies); E2E Testing Patterns implements *how* to code it.
- `android-testing-patterns` - Android-specific testing patterns
...
**Typical Workflow:**
1. **QA Expert**: Define test strategy, write test cases (TC-E2E-001, etc.)
2. **E2E Testing Patterns**: Implement those cases in Playwright/Cypress
3. **QA Expert**: Track execution, file bugs, generate reports, enforce quality gates
